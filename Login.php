      ...
      <div class="bg-image"></div>
        <div class="container-fluid">
          <div class="py-3" style="position:relative;">
            <h2 class="d-block px-4 py-4"><legend style="position:absolute;left:30px;top:10px;font-size:50px;color:white;text-decoration: underline;">CareerKadam</legend></h2>
          </div>
          <div id="registration" class="container justify-content-center align-items-center w-50 py-4 px-4 mx-auto my-4 font-weight-bold" style="border-radius:16px;color:white;">
            <form class="d-block" action="validation.php" method="post">
              <fieldset class="border p-4" style="border-radius:16px;">
                <legend class="w-auto mx-4 px-2 font-weight-bold" style="color:white;font-family:verdana;">User Login</legend>
