      ...
      <div class="container "><br>
         <div class="container">
            ...
            <div class=" col-lg-12 text-center">
               <h3> <a href="#" class="text-uppercase text-warning"> <?php echo $_SESSION['username']; ?>,</a> Welcome to CareerQuiz </h3>
            </div>
            <br>
            <div class="col-lg-8 d-block m-auto bg-light quizsetting ">
               ...
               <form action="checked.php" method="post">
                  <?php
                  $sql1 = "SELECT count(*) as re  FROM `questions` ";
                  ...
                  <div class="card">
                     ...
                     <?php
                        $sql = "SELECT * FROM `answers` WHERE `q_id` = $i limit 4";
                     ...
                     <div class="card-block">
                        <input type="radio" name="quizcheck[<?php echo $ansid; ?>]" id="<?php echo $ansid; ?>" value="<?php echo $row['ansid']; ?>" > <?php echo $row['ans']; ?>
                        <br>
                     </div>
                     <?php
         ...
         <br>
         <footer>
            <h5 class="text-center"> &copy2019 careerkadam </h5>
         </footer>
      </div>
