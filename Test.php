...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <ul class="nav nav-pills">
        <li class="nav-item dropdown bg-light">
          ...
          <div class="dropdown-menu p-0 bg-light">
            ...
            <a class="dropdown-item" href="Landingpage.php">Logout</a>
          </div>
      </li>
      </ul>
    </nav>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark m-0 p-0">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item A px-3  py-1 ">
            <a class="nav-link font-weight-bold" style="color:white;" href="Test.php" tabindex="-1" aria-disabled="true">Tests Pendings</a>
          </li>
          <li class="nav-item A px-3  py-1 ">
            <a class="nav-link font-weight-bold" style="color:white;" href="#" tabindex="-1" aria-disabled="true">Score Report</a>
          </li>
          <li class="nav-item A px-3  py-1 ">
    ...
    <h1>Currently No Tests Pending For You.</h1>
    <h1 style="margin:350px;"></h1>
